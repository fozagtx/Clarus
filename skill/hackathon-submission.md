...
| 2 | `./install.sh -y`, or paste `https://raw.githubusercontent.com/fozagtx/Clarus/main/skill/SKILL.md` into Binance Agent OS. |
| 3 | `Load https://raw.githubusercontent.com/fozagtx/Clarus/main/skill/SKILL.md`. Never sign. |
